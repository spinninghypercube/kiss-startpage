...
export function deriveEditModeColors(t) {
  ...
  const groupShift = isDarkColor(t.groupBackgroundColor) ? 12 : -12;
  const groupHoverShift = isDarkColor(t.groupBackgroundColor) ? 20 : -20;
  const primaryShift = isDarkColor(t.activeTabColor) ? 12 : -12;
  return {
    ...
    '--admin-button-bg': shadeColor(t.groupBackgroundColor, groupShift),
    '--admin-button-hover-bg': shadeColor(t.groupBackgroundColor, groupHoverShift),
    '--admin-button-border': alphaHex(t.textColor, 0.28),
    '--admin-button-primary-bg': t.activeTabColor,
    '--admin-button-primary-hover-bg': shadeColor(t.activeTabColor, primaryShift),
