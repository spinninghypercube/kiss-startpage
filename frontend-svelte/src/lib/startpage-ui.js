...
export function applyAdminThemePreview(themeLike, defaults) {
  ...
  const neutralButtonBg = blendHexColors(groupSurfaceColor, surfaceText, 0.12) || groupSurfaceColor;
  const neutralButtonHoverBg = blendHexColors(groupSurfaceColor, surfaceText, 0.2) || neutralButtonBg;
  const primaryButtonBg = activeTabColor || tabColor || inputFocusColor;
  const primaryButtonText = activeTabTextColor || pickHighContrastColor(primaryButtonBg);
  const primaryButtonHoverBg = blendHexColors(primaryButtonBg, pickHighContrastColor(primaryButtonBg), 0.12) || primaryButtonBg;
  const dangerButtonBg = '#dc2626';
  const dangerButtonText = pickHighContrastColor(dangerButtonBg);
  const dangerButtonHoverBg = blendHexColors(dangerButtonBg, pickHighContrastColor(dangerButtonBg), 0.12) || dangerButtonBg;
  const warningButtonBg = '#d97706';
  const warningButtonText = pickHighContrastColor(warningButtonBg);
  ...
  root.style.setProperty('--admin-button-bg', neutralButtonBg);
  root.style.setProperty('--admin-button-hover-bg', neutralButtonHoverBg);
  root.style.setProperty('--admin-button-text', surfaceText);
  root.style.setProperty('--admin-button-border', hexColorToRgba(surfaceText, 0.28));
  root.style.setProperty('--admin-button-primary-bg', primaryButtonBg);
  root.style.setProperty('--admin-button-primary-hover-bg', primaryButtonHoverBg);
  root.style.setProperty('--admin-button-primary-text', primaryButtonText);
  root.style.setProperty('--admin-button-danger-bg', dangerButtonBg);
  root.style.setProperty('--admin-button-danger-hover-bg', dangerButtonHoverBg);
  root.style.setProperty('--admin-button-danger-text', dangerButtonText);
  root.style.setProperty('--admin-button-warning-bg', warningButtonBg);
  root.style.setProperty('--admin-button-warning-text', warningButtonText);
}
